                              ...
                              ...List.generate(academicFiles.length, (index) {
                                ...
                                return ListTile(
                                  ...
                                  onTap: () async {
                                    ...
                                    await openLink(academicFiles[index].file.url);
                                  },
                                  ...
                                  title: clumsyTextLabel(academicFiles[index].name.toUpperCase(),color: appColors['primary']),
                                    subtitle: clumsyTextLabel(academicFiles[index].contentType.toUpperCase(),color: appColors['primary'],fontsize: 12)
                                  // subtitle: clumsyTextLabel(academicFiles[index].file.id,color: appColors['grey'],fontsize: 10),
