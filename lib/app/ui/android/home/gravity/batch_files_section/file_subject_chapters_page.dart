...
class FileSubjectChaptersPage extends StatefulWidget {
  FileSubjectChaptersPage({Key? key}):super(key: key){
    // Get.put<HostController>(HostController());
  }
  @override
  State<FileSubjectChaptersPage> createState() => _State();
}

class _State extends State<FileSubjectChaptersPage> {
    ...
    return SafeArea(
      child: Material(
        ...
        child: AsyncBuilder<APIResponse>(
          ...
          future: Get.find<StudentsController>().getFilesChaptersForSubject(batchId,subjectId),
          waiting: (context) {
            return  Center(
                            ...
                            child: Column(
                              children: [
                                ...
                                ...List.generate(chapters.length, (index) {
                                  ...
                                  return ListTile(
                                    onTap: (){
                                      Get.toNamed(Routes.BATCH_SUBJECT_CHAPTER_FILES_PAGE,arguments:{'subject':subjectId,'chapter':chapters[index].id,'batch':batchId});
                                      // print("yes");
                                    },
