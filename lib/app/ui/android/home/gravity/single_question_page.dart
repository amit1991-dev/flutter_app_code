...
class SingleQuestionPage extends StatefulWidget {
  SingleQuestionPage({Key? key}):super(key: key){
    // Get.put<HostController>(HostController());
  }
  @override
  State<SingleQuestionPage> createState() => _State();
}

class _State extends State<SingleQuestionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: AsyncBuilder<APIResponse>(
        future: Get.find<StudentsController>().getTestQuestion(questionId),
        waiting: (context) {
          return  Center(
