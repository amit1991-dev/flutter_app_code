...
//   LectureChapterPage({Key? key}):super(key: key){
//   }
//   @override
//   State<LectureChapterPage> createState() => _State();
// }

// class _State extends State<LectureChapterPage> {
...
//           future: Get.find<StudentsController>().getChapterLectures(batchId,subjectId,chapterId),
//           waiting: (context) {
//             return Center(
...
//             {
//               List<Lecture> lectures = apiResponse.data as List<Lecture> ;
//               print("lectures");
//               print(lectures);
//               return Container(
...
//                     children: [
//                       headerBar("Lectures",parent:true),
//                       if(lectures.isEmpty) Padding(
...
//                                 height: 50,
//                               ),
//                               if(lectures.isEmpty) clumsyTextLabel("Sorry, there are currently no chapters available in this Module!"),
//                               ...List.generate(lectures.length, (index) {
//                                 // return gravityTestsListTile(subjects[index]);
//                                 return ListTile(
//                                   onTap: (){
//                                     Get.toNamed(Routes.LECTURE_PAGE,arguments:lectures[index].id);
//                                     // print("yes");
//                                   },
//                                   tileColor: appColors['white'],
//                                   trailing: Icon(Icons.arrow_circle_right,color: appColors['primary'],),
//                                   title: clumsyTextLabel(lectures[index].name.toUpperCase(),color: appColors['primary']),
