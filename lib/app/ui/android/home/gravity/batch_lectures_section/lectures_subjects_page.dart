...
// class LecturesSubjectsPage extends StatefulWidget {
//   LecturesSubjectsPage({Key? key}):super(key: key){
//     // Get.put<HostController>(HostController());
//   }
//   @override
//   State<LecturesSubjectsPage> createState() => _State();
// }

// class _State extends State<LecturesSubjectsPage> {
//   late String batchId;
//   bool agreed = false;
//   _State(){
...
//           future: Get.find<StudentsController>().getSubjectsForLectures(batchId),
//           waiting: (context) {
//             return  Center(
...
//                                   height: 50,
//                                 ),
//                                 if(subjects.length==0) clumsyTextLabel("Sorry, there are currently no Lectures!"),
//                                 ...List.generate(subjects.length, (index) {
//                                   // return gravityTestsListTile(subjects[index]);
//                                   return ListTile(
//                                     onTap: (){
//                                       Get.toNamed(Routes.BATCH_SUBJECT_LECTURES_PAGE,arguments: {"subject":subjects[index].id,"batch":batchId});
//                                     },
