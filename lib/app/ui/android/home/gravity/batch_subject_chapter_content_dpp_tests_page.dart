...
// class BatchSubjectChapterContentDppTestsPage extends StatefulWidget {
//   BatchSubjectChapterContentDppTestsPage({Key? key}) : super(key: key) {}
//   @override
//   State<BatchSubjectChapterContentDppTestsPage> createState() => _State();
// }

// class _State extends State<BatchSubjectChapterContentDppTestsPage> {
...
//           future: Get.find<StudentsController>().getBatchSubjectChapterContentDppTests(batchChapterId),
//           waiting: (context) {
//             return Center(
...
//                       children: [
//                         headerBar("TopicWise",parent:true),
...
//                                 clumsyTextLabel("Topicwise tests",color: appColors['black']),
...
//                                   children: [
//                                     if (batch.dppTests.isEmpty)
//                                       Padding(
//                                         padding: const EdgeInsets.all(18.0),
//                                         child: clumsyTextLabel(
//                                             "Sorry, there are no tests for this topic.",
//                                             color: appColors["white"]),
//                                       ),
                                    
//                                     ...List.generate(batch.dppTests.length,
//                                         (index) {
//                                       return InkWell(
//                                         onTap: () {
//                                           Get.toNamed(
//                                             Routes.DPP_TEST_REPORT_PAGE,
//                                               arguments: [
//                                                 batch.dppTests[index].id,
//                                                 batch.id,
//                                               ]);
//                                         },
//                                         child:
      ...
      body: SafeArea(
        child: AsyncBuilder<APIResponse>(
          future: Get.find<StudentsController>()
              .getBatchSubjectChapterContentDppTests(batchChapterId),
          waiting: (context) {
            return Center(
              child: clumsyWaitingBar(),
            );
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: TabContainer(
                              ...
                              color: Colors.grey.shade300,
                              tabs: [
                                clumsyTextLabel("Topicwise tests",
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ListView.builder(
                                    itemCount: batch.dppTests.isEmpty
                                        ? 1 // Show a placeholder if the list is empty
                                        : batch.dppTests.length,
                                        ...
                                        return InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            child: ListTile(
                                              ...
                                              title: clumsyTextLabel(
                                                  batch.dppTests[index].name,
                                                  color: appColors['primary']),
                                              subtitle: clumsyTextLabel(
                                                  batch.dppTests[index]
                                                      .test_type,
                                                  color: appColors['primary'],
                                                  fontsize: 10),
                                            ),
