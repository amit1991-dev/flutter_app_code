...
class ResultQuestionPage extends StatefulWidget {
  ResultQuestionPage({Key? key}):super(key: key){
    // Get.put<HostController>(HostController());
  }
  @override
  State<ResultQuestionPage> createState() => _State();
}

class _State extends State<ResultQuestionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: AsyncBuilder<APIResponse>(
        future: Get.find<StudentsController>().getTestQuestion(qm.questionId),
        waiting: (context) {
          return  Center(
        ...
        builder: (context,apiResponse){
          ...
          {
            Question question = apiResponse.data as Question;
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        flex: 1,
                                         child: Text(qm.answer!=null? (qm.answer is String ? qm.answer : qm.answer.join(', ')) :"-",textAlign: TextAlign.center,style: TextStyle(fontSize: 25,color: appColors['primary']!),)
                                        // child: Text(qm.answer!=null?qm.answer:"-",textAlign: TextAlign.center,style: TextStyle(fontSize: 25,color: appColors['primary']!),)
                                    ),
  ...
  question.correctAns != null 
      ? (question.correctAns is String 
          ? question.correctAns!.toUpperCase() 
          : question.correctAns!.join(', ').toUpperCase()) 
      : "-",
