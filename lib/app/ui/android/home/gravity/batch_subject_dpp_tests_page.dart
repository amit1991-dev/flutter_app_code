...
class BatchSubjectDppTestsPage extends StatefulWidget {
  BatchSubjectDppTestsPage({Key? key}) : super(key: key) {}
  @override
  State<BatchSubjectDppTestsPage> createState() => _State();
}

class _State extends State<BatchSubjectDppTestsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        ...
        future: Get.find<StudentsController>().getBatchSubjectDppTests(batchId),
        waiting: (context) {
          return Center(
                      ...
                      ...List.generate(batchSubjects.length, (index) {
                        return InkWell(
                          onTap: () {
                            ...
                            Get.toNamed(Routes.BATCH_SUBJECT_CHAPTER_DPP_TESTS_PAGE,
