...
import 'package:getx/app/data/model/gravity/dpp_test_report.dart';
...
class DppTestReportPage extends StatefulWidget {
  DppTestReportPage({Key? key}) : super(key: key) {
    // Get.put<HostController>(HostController());
  }
  @override
  State<DppTestReportPage> createState() => _State();
}

class _State extends State<DppTestReportPage> {
  late String testId;
  late String batchId;
  bool agreed = false;
  _State() {
    ...
    return SafeArea(
      child: Material(
        ...
        child: AsyncBuilder<APIResponse>(
          future: Get.find<StudentsController>().getDppTestReport(testId),
          waiting: (context) {
            return Center(
          ...
          builder: (context, apiResponse) {
            if (apiResponse!.status == TextMessages.SUCCESS) {
              DppTestReport testReport = apiResponse.data as DppTestReport;
              return Column(
                children: [
                  headerBar("Test Report", parent: true),
                  testItemWidgetDpp(testReport.test),
                  if (testReport.test.startTime != null
                    ...
                    ClumsyRealButton("Start", Get.width * 0.7, () async {
                      APIResponse res = await Get.find<StudentsController>()
                          .createNewDppTestState(testId,batchId);
                      ...
                      await Get.toNamed(Routes.DPP_TEST_PAGE, arguments: res.data);
                      setState(() {});
                    }, false),
                  Expanded(
                          ...
                          if (testReport.testStates.length > 0)
                            ...List.generate(testReport.testStates.length,
                              ...
                              return Container(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    Get.toNamed(Routes.DPP_TEST_PAGE,arguments: {"test":testId,"test_state":testReport.testStates[index].id});
                                  },
                                  child: Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      MaterialButton(
                                        onPressed: () async {
                                          await Get.toNamed(Routes.DPP_TEST_PAGE,
                                ...
                                child: Row(
                                  ...
                                  const  SizedBox(
                                   ...
                                   const SizedBox(
                                    ...
                                    MaterialButton(
                                      onPressed: () {
                                        Get.toNamed(Routes.DPP_TEST_RESULT_PAGE,
                                            arguments:
