    ...
    return SafeArea(
      child: Material(
        ...
        child: AsyncBuilder<APIResponse>(
          future: Get.find<StudentsController>().getExam(examId,subjectId,chapterId),
          waiting: (context) {
            return  Center(
                ...
                return Scaffold(
                  ...
                  body: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        headerBar("Questions",parent: true),
                        // Padding(
                        //   padding: const EdgeInsets.all(8.0),
                        //   child: clumsyTextLabel(exam.name,color: appColors['primary']),
                        // ),
                        // Padding(
                        //   padding: const EdgeInsets.all(8.0),
                        //   child: clumsyTextLabel(DateTime.parse(exam.examDate).toIso8601String().split("T")[0],color: appColors['primary']),
                        // ),
                        ...
                        //   title: clumsyTextLabel(exam.name.toUpperCase(),fontsize: 18,color: appColors['primary']),
                        //   subtitle: clumsyTextLabel(DateTime.parse(exam.examDate).toIso8601String().split("T")[0],color: appColors['primary'],fontsize: 12),
                        // ),
                        Expanded(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            // ClumsyRealButton("Attempt", Get.width*0.3, () { }, false),
                                            ...
                                            InkWell(
                                              ...
                                              child: Icon(Icons.arrow_circle_right,color: appColors['primary'],),
                                            )
