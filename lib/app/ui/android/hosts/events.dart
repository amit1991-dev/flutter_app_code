...
class _HostEventsPageState extends State<HostEventsPage> {
  ...
  Widget build(BuildContext context) {
    return Material(
        ...
        child: Column(
          children: [
            headerBar("Your Events",parent: false),
            Expanded(
              child: AsyncBuilder<APIResponse>(
                future: Get.find<HostController>().getMyEvents(test: false),
                waiting: (context) {
                  return Center(
                            ...
                            children: [
                              ...
                              if(events.length>0)
                                ...List.generate(events.length, (index){
                                  return hostsEventListTile(events[index]);
                                })
                              else
                                Center(
                                  child: Column(
                                    children: [
                                      ...
                                      Text("Seems like You have created 0 Events"),
