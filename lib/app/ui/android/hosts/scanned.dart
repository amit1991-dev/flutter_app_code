...
class ScannedBookingPage extends StatefulWidget {
  ScannedBookingPage({Key? key}):super(key: key){
    // Get.put<HostController>(HostController());
  }
  @override
  State<ScannedBookingPage> createState() => _State();
}

class _State extends State<ScannedBookingPage> {
