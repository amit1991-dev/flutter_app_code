...
class HelperScannerPage extends StatefulWidget {
  HelperScannerPage({super.key});

  // String cityName = "a";

  @override
  State<HelperScannerPage> createState() => _HelperScannerPageState();
}

class _HelperScannerPageState extends State<HelperScannerPage> {
  bool flashOn = false;
  MobileScannerController cameraController = MobileScannerController(torchEnabled: false);
  GlobalKey<AutoCompleteTextFieldState<String>> key = GlobalKey();

  _HelperScannerPageState(){
