...
class Result{
  ...
  Result(this.id,this.studentId,this.testId,this.total,this.maxMarks,this.qml,this.duration,this.attemptNumber,{this.declarationTime}) {
  ...
  factory Result.fromJson(Map<String,dynamic> json)
  {
    ...
    print(json['duration']);
    return Result(json['_id'],json['student'],json['test'],json['total'],json['max_marks'],qml,json['duration'],json['attempt_number']??0,declarationTime: json['declaration_time']);
  }
