...
class DppTestSection {
  late String name,sectionType;
  late List<DppTestQuestion> sectionQuestions;
  late int requiredOptionalQuestionsCount;
  // int numberMarked = 0;
  List<int> markedQuestions = [];
  DppTestSection({required this.name,required this.sectionType,required this.sectionQuestions});

  DppTestSection.fromJSON(Map<String,dynamic> json)
  {
    print("testSection");
    var questions = json['questions'];
    sectionQuestions = [];
    for(var question in questions){
      sectionQuestions.add(DppTestQuestion.fromJson(question,testSection: this));
    }
    print("testSection");
    name=json['name'];
    print("asdad");
