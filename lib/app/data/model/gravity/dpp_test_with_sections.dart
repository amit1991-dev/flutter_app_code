...
import "dpp_test_section.dart";

class DppTestWithSections {
  late String name, id, test_type, instructions;
  late int duration, max_marks;

  Map<String, List<DppTestQuestion>>? subjectWise;
  List<DppTestQuestion>? lq;
  List<DppTestSection>? testSections;

  String? startTime, endTime;

  DppTestWithSections.fromJSON(Map<String, dynamic> json, bool questions) {
    ...
    if (questions) {
      ...
      for (var section in sections) {
        testSections!.add(DppTestSection.fromJSON(section));
      }
      print("object6");
